...
public class Game extends Thread {
	...
	public void screenDraw(Graphics2D g) {
		...
		g.drawImage(blueFlareImage, 400, 270, null);
		g.drawImage(judgeImage, 460, 460, null);
	...
	public void dropNotes(String titleName) {
		Beat[] beats = null;
		if(titleName.equals("Boy with Luv - BTS") && difficulty.equals("Easy")) {
			int startTime = 16000 - Main.REACH_TIME * 1000;
			int gap = 500;
			beats = new Beat[] {
					...
					new Beat(startTime + gap * 21, "Space"),
					...
					new Beat(startTime + gap * 279, "Space"),
		...
		else if(titleName.equals("Boy with Luv - BTS") && difficulty.equals("Hard")) {
			int startTime = 16000 - Main.REACH_TIME * 1000;
			int gap = 250;
			beats = new Beat[] {
					new Beat(startTime, "Space"),
		...
		else if(titleName.equals("Go Go - BTS")&& difficulty.equals("Easy")) {
			int startTime = 1000;
			beats = new Beat[] {
					new Beat(startTime, "Space"),
					//working now
		...
		else if(titleName.equals("Go Go - BTS")&& difficulty.equals("Hard")) {
			int startTime = 1000;
			beats = new Beat[] {
					new Beat(startTime, "Space"),
					//working now
		...
		else if(titleName.equals("Idol - BTS")&& difficulty.equals("Easy")) {
			int startTime = 1000;
			beats = new Beat[] {
					new Beat(startTime, "Space"),
					//working now
		...
		else if(titleName.equals("Idol - BTS")&& difficulty.equals("Hard")) {
			int startTime = 1000;
			beats = new Beat[] {
					new Beat(startTime, "Space"),
					//working now
